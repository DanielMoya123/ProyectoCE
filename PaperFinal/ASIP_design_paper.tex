...
restrict the performance of a chip. Application-Specific Instruction Processors (ASIPs) are used to propose
a solution towards the use of the  approximate computing area, which is a design paradigm that proposes a reduction 
in the accuracy or precision of the computation to obtain opportunities for improvement in terms of
...
\noindent
\textbf{Contribution: }
This work evaluates the design performance, in area, power and execution time, of ASIPs with special instructions
