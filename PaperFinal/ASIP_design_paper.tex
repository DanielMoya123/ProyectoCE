...
\addplot+[ybar,postaction={pattern=north east lines}] plot coordinates {(eucl,0) (absv,0) 
  (sob,0) (none,0)};
...
% \resizebox{0.5\textwidth}{!}{\begin{tabular}{|c|c|c|c|} 
%  \hline
% \multicolumn{2}{|c|}{With the \emph{absv} instruction} [fill=KITgreen70,postaction={pattern=north east lines}] &\multicolumn{2}{|c|}{Without the \emph{absv} instruction}\\ \hline
% Total Cycles	&\# Integer Operations	&Total Cycles	&\# Integer Operations	 \\ \hline
