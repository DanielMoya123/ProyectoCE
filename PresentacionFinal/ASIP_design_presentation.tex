...
\begin{itemize}
\item SALSA: síntesis de circuito combinacional \cite{venkataramani2012salsa} 
\item ASLAN: síntesis de circuito secuencial \cite{ranjan2014aslan}
\item ABACUS: síntesis a partir de descripción de comportamiento \cite{nepal2014abacus}
\end{itemize}
...
\vspace*{-1.5cm}
\begin{center}
 {\tiny \ Tomado de \cite{henkel2006design}}
\end{center}
\end{columns}
