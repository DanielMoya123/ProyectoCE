...
of alu] (asip) {\makecell{Lógica\\de la IS}};
...
\addplot+[ybar] plot coordinates {(eucl,335) (absv,333) 
  (sob,333) (none,330)};
\legend{, Potencia Estática, Potencia Dinámica}
\end{axis}
\end{tikzpicture}}
\label{fig:power}
\end{figure}
...
\begin{itemize} 
 \item Se puede obtener una mejora de casi 2X con un costo mínimo de un 1\% en área y hasta 5mW en consumo de potencia.
\end{itemize}
\bigskip
\begin{itemize}
 \item \textbf{Trabajo Futuro}: se puede tener una ejecución más rápida si se utilizan aproximaciones ya sea a nivel de software o hardware.
\end{itemize}
