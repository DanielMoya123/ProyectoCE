...
\begin{itemize} 
 \item Para un overhead casi insiginicativo en área 1\% y un 5mW, se pueden tener hasta 2x se logró tener hasta una mejora de tanto
 
 \item Esto nos da la oportunidad de que si esta ejecución pueden ser más rápida debido a aproximaciones, todavía se puede generar un mayor speedup
\end{itemize}
