...
paradigma de diseño que que propone una reducción en la precisión o exactitud de
...
de una sección). La Figura \ref{fig:problem} muestra una aplicación genérica
...
\end{tikzpicture} 
\medskip
\caption{Una posible situación a resolver en este proyecto.} 
\label{fig:problem}
\end{figure}
...
través de pragmas propios, qué funciones del código son tolerantes a errores y
el cuals es transformado a una representación intermedia. A través del algoritmo
que se pretende desarrollar, para escoger cuáles versiones aproximadas de
...
El proyecto iniciará con una etapa de investigación sobre trabajos realizados
...
cierto lenguaje y con el reconocmiento de pragmas o anotaciones en el código.
...
desarrollo, sin embargo, la redacción de un artículo científico y demás
documentos propios de un trabajo final de graduación, se desarrollarán como una
etapa adicional.
...
tiempo de ejecución; esto sirve como herramienta a un investigar para que ajuste
