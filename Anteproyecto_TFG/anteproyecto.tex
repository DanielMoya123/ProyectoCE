...
cierto lenguaje y que permita el reconocmiento de pragmas o anotaciones en el código.
...
\node[mynode, below=1cm of investigacion] (compilador) {Generación de compilador para pragmas propios};
