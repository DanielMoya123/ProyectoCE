...
\subsection{External interfaces}
 As explained in section \ref{sec:persp}, the entire optimizaded application
...
As explained in section \ref{sec:user}, the users are expected to be researchers, for this only few 
...
\begin{itemize}
 ...
 \item Development framework: The ASIPs are going to be developed with the use of ASIPMeister and Dlxsim, which are the ones
 already presented in the work environment. 
 ...
 is not going to be altered, since the optimizations are going to be implemented by hardware modules. 
...
Approximate computing has been studied by several authors, the survey \cite{xu2018approximate} gathers many ways to implement
...
The produced documentation will be carefully revised by the supervisor in order to aprove it.
